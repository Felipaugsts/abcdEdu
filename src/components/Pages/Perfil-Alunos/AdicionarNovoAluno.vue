      ...
      <v-flex class="d-flex justify-center align-center">
        <v-card class="card">
          <v-card-title class="d-flex mt-3 flex-column justify-center">
            ...
            />
            <Button class="edit_avatar" label="Mudar Avatar" />
          </v-card-title>
          <v-card-text class="d-flex flex-column align-center">
            <v-form class="form mt-4">
              <TextField :fields="Name" class="mb-3" />
              <TextField :fields="Escola" />
            </v-form>
          </v-card-text>
          ...
          <v-card-actions class="justify-center mt-5">
            <Button label="Adicionar aluno" tipo="primary" />
          </v-card-actions>
        </v-card>
      </v-flex>
    </v-layout>
